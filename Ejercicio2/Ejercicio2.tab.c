...
#line 18 "Ejercicio2.y"
                         { printf("= %d (0x%X)\n", yyvsp[-1], yyvsp[-1]); }
#line 1075 "Ejercicio2.tab.c"
    break;

  case 5: /* exp: exp ADD factor  */
#line 23 "Ejercicio2.y"
